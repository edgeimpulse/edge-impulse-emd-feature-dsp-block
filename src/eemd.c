...
inline static void array_copy(double const* __restrict__ src, size_t n, double* __restrict__ dest) {
...
typedef struct {
	...
	size_t N;
	// Found extrema
	double* __restrict__ maxx;
	double* __restrict__ maxy;
	double* __restrict__ minx;
	double* __restrict__ miny;
	// Upper and lower envelope spline values
	double* __restrict__ maxspline;
	double* __restrict__ minspline;
	// Extra memory required for spline evaluation
	double* __restrict__ spline_workspace;
} sifting_workspace;
...
typedef struct {
	...
	sifting_workspace* __restrict__ sift_w;
...
typedef struct {
	...
	emd_workspace* __restrict__ emd_w;
} eemd_workspace;
...
static libeemd_error_code _emd(double* __restrict__ input, emd_workspace* __restrict__ w,
		double* __restrict__ output, size_t M,
...
static libeemd_error_code _sift(double* __restrict__ input, sifting_workspace*
		__restrict__ w, unsigned int S_number, unsigned int num_siftings, unsigned int*
		sift_counter);
...
libeemd_error_code eemd(double const* __restrict__ input, size_t N,
		double* __restrict__ output, size_t M,
...
libeemd_error_code ceemdan(double const* __restrict__ input, size_t N,
		double* __restrict__ output, size_t M,
		unsigned int ensemble_size, double noise_strength, unsigned int
		S_number, unsigned int num_siftings, unsigned long int rng_seed) {
	gsl_set_error_handler_off();
	...
	double* __restrict__ res = (double*)malloc(N*sizeof(double));
...
static libeemd_error_code _sift(double* __restrict__ input, sifting_workspace*
		__restrict__ w, unsigned int S_number, unsigned int num_siftings,
...
void emd_find_extrema(double const* __restrict__ x, size_t N,
		double* __restrict__ maxx, double* __restrict__ maxy, size_t* nmax,
		double* __restrict__ minx, double* __restrict__ miny, size_t* nmin,
		size_t* nzc) {
...
libeemd_error_code emd_evaluate_spline(double const* __restrict__ x, double const* __restrict__ y,
		size_t N, double* __restrict__ spline_y, double* __restrict__ spline_workspace) {
	gsl_set_error_handler_off();
	const size_t n = N-1;
