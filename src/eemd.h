...
void emd_find_extrema(double const* __restrict__ x, size_t N,
		double* __restrict__ maxx, double* __restrict__ maxy, size_t* num_max_ptr,
		double* __restrict__ minx, double* __restrict__ miny, size_t* num_min_ptr,
...
libeemd_error_code emd_evaluate_spline(double const* __restrict__ x, double const* __restrict__ y,
		size_t N, double* __restrict__ spline_y, double* spline_workspace);
